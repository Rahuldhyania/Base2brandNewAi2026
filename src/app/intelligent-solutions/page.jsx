...
const CoreTechnologies = dynamic(() => import("@/components/Solutions/CoreTechnologies"), {
  loading: () => <SectionFallback minHeight={480} />,
});
...
const page = () => {
  return (
    <div>
      <Hero
        highlightTag="INTELLIGENT CONNECTED SOLUTIONS"
        titleupper="Building Intelligent"
        titlelower="Connected Experiences"
        description="We combine AI, IoT, Computer Vision, and intelligent software to build connected ecosystems that improve visibility, automate decisions, and optimize operations—helping people, systems, and assets work together seamlessly."
        buttonLeft="Build Connected Solutions"
        buttonRight="Explore Our Capabilities"
      />
