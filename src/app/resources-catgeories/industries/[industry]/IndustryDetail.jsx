...
import { IndustryDetailSkeleton } from "../../components/ResourceSkeletons";
  ...
  useEffect(() => {
    ...
    const loadIndustry = async () => {
      try {
        ...
        const [detail, allIndustries] = await Promise.all([
          getIndustryBySlug(slug),
          fetchIndustries({ limit: 50 }),
        ]);
