      ...
      <div className="relative overflow-hidden p-6">
        <div className="mb-4 flex items-center justify-between">
          <div>
            ...
            <div className="mt-1 font-display text-[22px] leading-tight text-white md:text-[26px]">
              Live telemetry
            </div>
          </div>

          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-[var(--b2b-orange)] to-white/5">
            <svg
              width="14"
              height="14"
              viewBox="0 0 14 14"
        ...
        {preview.lines.length > 0 && (
          <div className="mb-4 grid grid-cols-2 gap-3 sm:grid-cols-3">
            {preview.lines.slice(0, 3).map((line, lineIndex) => (
              <div
              ...
              >
                ...
                <div className="font-display text-[16px] tracking-[-0.02em] text-white">
                  {line.value}
                </div>
              </div>
            ))}
        ...
        <div className="overflow-hidden rounded-lg border border-white/5 bg-white/[0.02] p-2">
          {preview.screenshot ? (
            <motion.img
              src={preview.screenshot}
              alt={`${project.title} dashboard preview`}
              ...
              className="h-[220px] w-full rounded-md object-cover will-change-transform md:h-[250px]"
              loading="lazy"
            />
          ) : (
            <div className="flex h-[220px] items-center justify-center rounded-md border border-dashed border-white/20 bg-[#0c101a] px-6 text-center md:h-[250px]">
