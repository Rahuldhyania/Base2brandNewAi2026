...
export function IlluminatedHero({
    ...
    return (
        <div
            ...
            <div className="absolute bottom-0 left-0 right-0 border-t border-white/[0.08] backdrop-blur-sm z-10">
                <div className="mx-auto max-w-[1320px] px-5 sm:px-6 lg:px-8">
                    <div className="py-3 flex items-center gap-6 overflow-hidden justify-center">
                        {[
                            "PIPELINE · ONLINE",
