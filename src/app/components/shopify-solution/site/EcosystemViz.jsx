...
export const EcosystemViz = () => {
  ...
  return (
    ...
    >
      <div className="glow-left -left-[1100px] top-1/2 -translate-y-1/2 hidden md:block" />

      <div className="glow-right -right-[1100px] top-1/2 -translate-y-1/2 hidden md:block" />
