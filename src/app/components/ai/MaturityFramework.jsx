...
const STAGES = [
  {
    label: "AI Assistants",
    desc: "Q&A chat, single-task helpers. Limited memory, no execution.",
    note: "Common baseline. Often deployed as features rather than systems.",
  },
  {
    label: "AI Automation",
    desc: "Models embedded into workflows. Triggered actions, light orchestration.",
    note: "Improves task throughput, but lacks reasoning across systems.",
  },
  {
    label: "Agentic Systems",
    desc: "Goal-driven agents with tools, retrieval, and policy boundaries.",
    note: "Inflection point: software begins to plan, not just respond.",
  },
  {
    label: "Multi-Agent Operations",
    desc: "Coordinated agent teams executing cross-system workflows.",
    note: "Agent-to-agent collaboration with shared memory and guardrails.",
  },
  {
    label: "Decision Intelligence",
    desc: "Systems that synthesize signals and execute consequential actions.",
    note: "Reversibility, audit, and human-in-the-loop are first-class.",
  },
  {
    label: "Autonomous Enterprise",
    desc: "AI infrastructure operates the business with measurable outcomes.",
    note: "Where Base2Brand AI engagements are headed by design.",
  },
];
        ...
        <div className="relative w-full max-w-7xl mx-auto px-6 md:px-10">
          <div className="text-center max-w-3xl mx-auto mb-10 md:mb-12">
            ...
            <p className="mt-4 text-white/55 leading-relaxed">
              Scroll through six stages defining where modern organizations sit
              — and where autonomy actually begins.
            </p>
          </div>
