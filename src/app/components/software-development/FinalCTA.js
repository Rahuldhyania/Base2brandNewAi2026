    ...
    <section id="cta" className="pb-12 relative">
      ...
      <div className="b2b-container relative">
        <motion.div
          ...
          className="relative overflow-hidden rounded-lg md:rounded-3xl border border-white/[0.07] bg-gradient-to-br from-[#0a0e22] via-[#080c1e] to-[#05081a] p-4 md:p-8 lg:p-14"
        >
          {/* internal grid */}
          ...
          <div className="relative grid grid-cols-12 gap-6 md:gap-10">
            <div className="col-span-12 lg:col-span-7">
              ...
              <motion.div variants={fadeUp} className="mt-6 sm:mt-9 flex flex-wrap items-center gap-3">
                ...
                <a
                  href="#"
                  className="inline-flex items-center justify-center gap-2 rounded-full px-5 py-2.5 sm:px-6 sm:py-3 text-sm font-medium transition-all duration-300 bg-white/4 border border-white/12 text-[var(--b2b-fg)]"
