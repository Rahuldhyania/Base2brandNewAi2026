...
export const Problems = () => {
  return (
    <section
      ...
      className="relative py-12 md:py-16 bg-secondary/40 border-y border-border"
    >
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="max-w-3xl mb-12">
          ...
          <h2
            ...
            className="font-display font-bold uppercase text-balance md:leading-[0.95] tracking-tight text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-6"
          >
            The Challenges{" "}
          ...
          {problems.map((p, i) => {
            ...
            return (
              <m.div
                ...
                className="group relative p-4 md:p-8 border-r border-b border-border bg-background hover:bg-card transition-colors"
              >
