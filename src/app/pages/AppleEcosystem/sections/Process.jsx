        ...
        <div className="space-y-5">
          {STEPS.map((s, i) => (
            <motion.div
              ...
              className="grid grid-cols-[auto_1fr] lg:grid-cols-[120px_1fr] gap-5 lg:gap-10 items-start"
            >
              <div className="relative">
                <span className="font-display text-4xl lg:text-5xl text-white/15 leading-none">{s.n}</span>
                <span
